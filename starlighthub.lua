...
local Title = "Starlight V1" .. (getgenv().Premium and " [Premium]" or "")
local SubTitle = "V1 tiktok.com/@nhonayliettoan"
...
local UiOrders = {"Chính","Mục Auto Farm","Sub Farm","Trạng Thái","Trạng Thái Player","Trái Ác Quỷ","Local Player","Dịch Chuyển","PVP-Hiển Thị","Raid-Nguyên Liệu","V4-Đảo Bí Ẩn","Sự Kiện Sea","Cửa Hàng","Cài Đặt","Webhook","Game-Server","One Click"}
...
local UiIntilize = {
    ["Chính"] = {
        {Mode="Label",Title="Chỉ Bật 1 Cái Cùng Lúc"},
        {Mode="Toggle",Title="Tự Động Katakuri",Description="Bật Đánh Katakuri Và Triệu Hồi",Args={"Katakuri","Enable"}},
        {Mode="Toggle",Title="Farm Xương",Description="",Args={"Bone","Enable"}},
        {Mode="Toggle",Title="Kill Aura",Description="Farm Quái Cùng LV",Args={"Kill Aura","Enable"}},
        {Mode="Toggle",Title="Tự Động Dough King",Description="",Args={"Full Dough King","Enable"}},
        {Mode="Label",Title="Cài Đặt Tự Động Farm"},
        {Mode="Label",Title="Vị Trí Anchor"},
        {Mode="Toggle",Title="TP Lại Vị Trí Anchor",Description="Nếu Vượt Quá Vị Trí Anchor Sẽ TP Lại Vị Trí Anchor",Args={"Kill Aura","AnchorTPBack"}},
        {Mode="Button",Title="Đặt Vị Trí Anchor",Callback=function ()
            pcall(function ()
                getgenv().Setting["Kill Aura"].AnchorPosition = tostring(game.Players.LocalPlayer.Character.HumanoidRootPart.Position)
            end)
        end},
        {Mode="Dropdown",Title="Khoảng Cách Tới Anchor",Table = (function ()
            local Table = {}
        ...
        {Mode="Toggle",Title="Dùng Kiếm",Args = {"Mastery","Sword"}},
        {Mode="Toggle",Title="Tự Động Trang Bị Kiếm",Description="Tự Động Đổi Kiếm Nếu Chưa Đủ Skill Hoặc Max Thông Thạo",Args={"SwordSwitcher","Enable"}},
        {Mode="Toggle",Title="Chỉ Đổi Kiếm Khi Max Thông Thạo",Description="Chỉ Đổi Khi Max Thông Thạo",Args={"SwordSwitcher","MaxMastery"}},
        {Mode="Toggle",Title="Trang Bị Kiếm Khi Quái Yếu Máu", Description = "Chỉ Bật Đổi Kiếm", Args={"Mastery","Sword/Low"}},
        {Mode="Label",Title="Tới Cài Đặt Để Chọn Skill"},
        {Mode="Toggle",Title="Farm Thông Thạo",Description="Nên Bật Khi Tự Động Katakuri Hoặc Xương", Args={"Mastery","Enable"}},
        {Mode="Toggle",Title ="Aimbot Camera " ,Description = "Aimbot Cho Thông Thạo Bằng Camera", Args={"Mastery","Camera"}},
        {
            Mode = "Dropdown",
            Title = "Máu Để Cày Mastery Cho Quái",
            Args = {"Mastery", "Health"},
        ...
        {Mode="Toggle",Title="Thông Thạo Kiếm / Súng", Description = "Mặc Định Là Trái, Bật lên khi dùng súng hoặc kiếm",Args = {"Mastery","Fruit/Gun"}},
        {
            Mode = "Toggle",
            Title = "Tắt Aim Gần Nhất",
    ...
    ["Stack Auto farm"] = {
        ...
        {Mode="Toggle",Title="Tự Động Đánh Elite",Description="Bật Khi Ở Sea 3",Args={"Elite","Enable"}},
        {Mode="Toggle",Title="Tự Động Hải Tặc Đột Kích",Description="Bật Khi Ở Sea 3",Args={"Pirate Raid","Enable"}},
        {Mode="Toggle",Title="Tự Động Bật Haki Pad",Description="Bật Khi Ở Sea 3",Args={"Open Pad","Enable"}},
        {Mode="Toggle",Title="Tự Động Triệu Hồi Rip Indra",Description="Bật Khi Ở Sea 3", Args = {"Spawn Rip Indra","Enable"}},
        {Mode="Toggle",Title="Tự Động Đánh Rip Indra",Description = "Chỉ Đánh Rip Indra,không làm gì khác",Args={"Rip Indra","Enable"}},
        {Mode="Toggle",Title="Tự Động Lấy Tushita",Descrition="Bật Khi Ở Sea 3",Args={"Tushita","Enable"}},
        {Mode="Toggle",Title="Tự Động Giải Đố Electric Claw",Description="Bật Khi Ở Sea 3",Args={"Unlock Electric Claw","Enable"}},
        {Mode="Toggle",Title="Tự Động Đánh Dough King" ,Description="", Args = {"Dough King","Enable"}},
        {Mode="Toggle",Title="Tự Động Đánh Cake Prince",Description="",Args = {"Cake Prince","Enable"}},
        {Mode="Toggle",Title="Tự Động Triệu Hồi Soul Reaper",Args = {"Spawn Soul Reaper","Enable"}},
        {Mode="Toggle",Title="Tự Động Đánh Soul Reaper",Args = {"Soul Reaper","Enable"}},
        {
            Mode = "Dropdown",
            Title = "Chọn Boss Để Nhắm(khi server có boss tự động đánh)",
            Multi = true, 
        ...
        {Mode="Toggle",Title="Bắt Đầu Nhắm Boss",Description="",Args={"BossSniper","Enable"}},
        {Mode="Toggle",Title="Tự Động Làm Nhiệm Vụ Bartilo",Description="Sea 2 Function",Args = {"Bartilo","Enable"}},
        {Mode="Toggle",Title="Tự Động Giải Đố Tộc",Description="Sea 2 Function, Need Bartilo Quest Finish",Args = {"Race Evolve","Enable"}},
        {Mode="Toggle",Title="Tự Động Đánh Factory",Description="Sea 2 Function Only",Args = {"Factory","Enable"}},
        {Mode="Toggle",Title="Tự Động Spawn Râu Đen",Description="Sea 2 Function Only", Args = {"Spawn Black Beard","Enable"}},
        {Mode="Toggle",Title="Tự Động Đánh Râu Đen Black Beard",Description="Sea 2 Function Only", Args = {"Black Beard","Enable"}},
        {Mode="Toggle",Title="Tự Động Đánh Ghoul",Description="Travel To Sea2 and Stack Farming Until Have Ghoul", Args = {"Get Ghoul","Enable"}},
        {Mode="Toggle",Title="Tự Động Lấy Soul Guitar",Args = {"Soul Guitar","Enable"}},
...
local UiIntilize = {
    ...
    ["Stack Auto farm"] = {
        {Mode="Label",Title="Can Turn On Many Auto Farm Cuz Stackable"},
        {Mode="Toggle",Title="Auto Elite",Description="Bật Khi Ở Sea 3",Args={"Elite","Enable"}},
        {Mode="Toggle",Title="Auto Pirate Raid",Description="Bật Khi Ở Sea 3",Args={"Pirate Raid","Enable"}},
        {Mode="Toggle",Title="Auto Open Haki Pad",Description="Bật Khi Ở Sea 3",Args={"Open Pad","Enable"}},
        {Mode="Toggle",Title="Auto Spawn Rip Indra",Description="Bật Khi Ở Sea 3", Args = {"Spawn Rip Indra","Enable"}},
        {Mode="Toggle",Title="Auto Rip Indra",Description = "Only Kill Rip Indra, Doesnt Do Anything Else",Args={"Rip Indra","Enable"}},
        {Mode="Toggle",Title="Auto Tushita",Descrition="Bật Khi Ở Sea 3",Args={"Tushita","Enable"}},
        {Mode="Toggle",Title="Do Puzzle Electric Claw",Description="Bật Khi Ở Sea 3",Args={"Unlock Electric Claw","Enable"}},
