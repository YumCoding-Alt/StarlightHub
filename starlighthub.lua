...
spawn(
    function()
        ...
        require(game.ReplicatedStorage.Notification).new("<Color=Red>Starlight Hub<Color=/>"):Display()
        wait(.5)
        require(game.ReplicatedStorage.Notification).new("<Color=Green>Thank You Because Used My Script Love U❤️<Color=/>"):Display()
        wait(.8)
    end
)
shared.LoaderTitle = "Starlight Hub";
...
v16.Home:AddButton({
    ...
    Description = "Tại Đây",
    Callback = function()
        setclipboard("https://www.tiktok.com/@nhonayliettoan");
    end
});
    ...
    v505.RenderStepped:Connect(function()
        ...
        if v594 then
            ...
            if not v513 then
                v14:Notify({
                    Title = "Starlight Hub",
                    Content = "Đã Tìm Thấy Đảo Tiền Sử",
                    Duration = 10
                });
                v513 = true;
            end
    ...
    v505.RenderStepped:Connect(function()
        ...
        if v616 then
            ...
            if not v513 then
                v14:Notify({
                    Title = "Starlight Hub",
                    Content = "Đã Tìm Thấy Đảo Leviathan ",
                    Duration = 10
                });
                v513 = true;
            end
